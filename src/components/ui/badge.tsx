  ...
  "inline-flex items-center rounded-full border-2 px-3 py-1 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-foreground shadow-sm border-gray-300 hover:border-gray-400 hover:bg-gray-50",
        gradient: "border-transparent bg-gradient-to-r from-black to-gray-700 text-primary-foreground shadow",
      },
    },
    defaultVariants: {
      variant: "default",
