...
const LatestReleases = ({ isVisible }: LatestReleasesProps) => {
  ...
  return (
    <section className={cn(
      "py-20 bg-black text-white transition-opacity duration-700",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="w-10 h-1 bg-white mx-auto mb-16"></div>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {releases.map((release) => (
            <div key={release.id} className="bg-black border border-gray-800 transition-transform hover:scale-105">
              ...
              <div className="p-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button className="text-sm flex items-center hover:text-gray-300">
                    Слушать →
                  </button>
                </div>
              </div>
